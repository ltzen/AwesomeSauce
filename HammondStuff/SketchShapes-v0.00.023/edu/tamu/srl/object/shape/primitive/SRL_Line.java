 ...
 */
public class SRL_Line extends SRL_Shape{

	/**
	 * Starting value of the line
	 */
	private SRL_Point m_p1;
	/**
	 * Ending value of the line
	 */
	private SRL_Point m_p2;  
	 ...
	 */
	public SRL_Line clone(){
		SRL_Line cloned = new SRL_Line(m_p1.clone(), m_p2.clone());
		super.clone(cloned);
	    return cloned;
	}
	 ...
	 */
	public void setP1(SRL_Point p1) {
		m_p1 = p1;
	}
	 ...
	 */
	public void setP2(SRL_Point p2) {
		m_p2 = p2;
	}
	 ...
	 * @param p2 end point
	 */
	public SRL_Line(SRL_Point p1, SRL_Point p2){
		m_p1 = p1;
		m_p2 = p2;
	...
	public static double[] getABCArray(double x1, double y1, double x2, double y2){
	 ...
	 /**
	  ...
	  public SRL_Point getIntersection(SRL_Line l){
	   ...
	   * @return the distance
	   */
	  public double distance(SRL_Point p){
	    SRL_Line perp = getPerpendicularLine(p);
	    SRL_Point intersectionPoint = getIntersection(perp);
	  ...
	  public static double distance(double px, double py, 
	    ...
	    if(l1_x1 == l1_x2 && l1_y1 == l1_y2){return SRL_Point.distance(l1_x1, l1_y1, px, py);}
	    ...
	    if(iPoint != null && overBoundingBox(iPoint[0], iPoint[1], l1_x1, l1_y1, l1_x2, l1_y2)){
	    	return SRL_Point.distance(px, py, iPoint[0], iPoint[1]);}
	    return Math.min(SRL_Point.distance(l1_x1, l1_y1, px, py),
	    		SRL_Point.distance(l1_x2, l1_y2, px, py));
	  }

	  public double distance(SRL_Line l){
	    SRL_Point intersectionPoint;
	    if(isParallel(l, .001)){
	   ...
	   */
	  public boolean overBoundingBox(SRL_Point p){
	   ...
	   */
	  public boolean isParallel(SRL_Line line, double percent_threshold){
	  ...
	  */
	   ...
	   */
	  public boolean intersects(SRL_Line line){
	   ...
	   */
	  public SRL_Line(double x1, double y1, double x2, double y2){
	    this(new SRL_Point(x1, y1), new SRL_Point(x2,y2));
	  }
	  ...
	  */
	 public SRL_Line getPerpendicularLine(SRL_Point p){
	   ...
	   */
	  public SRL_Line getFlippedLine() {
	    return new SRL_Line(getP1(), getP2());
	  }
